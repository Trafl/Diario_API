...
public interface TurmaControllerDocumentation {
    ...
    ResponseEntity<PagedModel<EntityModel<TurmaPageDTOOutput>>> listTurmas(String numero, Turno turno, Integer anoLetivo, Long alunoId, Long diarioId, Pageable pageable);
    ...
    ResponseEntity<TurmaDTOOutput> getOneTurma(Long turma_id);
    ...
    ResponseEntity<TurmaDTOOutput> addTurma(TurmaDTOInput input);
    ...
    ResponseEntity<TurmaDTOOutput> updateTurma(Long turma_id,TurmaDTOInput input);
